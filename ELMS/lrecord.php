...
<body>
  ...
  <div class="sidebar">
    ...
    <a style="background:#D6EAF8" href="lrecord.php">Leave Records</a>
  ...
  $sql1 = "SELECT type ,start_date, datediff(end_date,start_date) as days, status from `project`.`leave_request` JOIN `project`.`employee` on employee.employee_id = leave_request.employee_id where email='$email';";
